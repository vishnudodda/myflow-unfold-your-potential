...
- roleModels: MUST be INDIA-BASED AND AGE-PROXIMATE. Each role model's CURRENT age (as of 2026) should ideally be within ~6 years of the user's age, OR their notable breakthrough happened at roughly the user's current age (±3 years) so the user sees "someone like me, just a few steps ahead." Prefer living contemporary Indian achievers the user can look up on Instagram/YouTube today. Never reuse the same 3 people for every user. Draw from pools like: young changemakers (Licypriya Kangujam, Tilak Mehta, Gitanjali Rao-style Indian equivalents), teen/young athletes (R Praggnanandhaa, D Gukesh, Vaibhav Suryavanshi, Sheetal Devi, Neeraj Chopra), young creators (Prajakta Koli, Kusha Kapila, Ranveer Allahbadia, Bhuvan Bam, Ranbir Allahbadia), young founders (Tilak Mehta, Kavin Bharti Mittal, Advait Thakur, Kaivalya Vohra of Zepto, Aadit Palicha of Zepto, Ritesh Agarwal), young researchers/coders (Rishabh Pant-style breakouts in their field). For older users (23-27) you can include figures like Kunal Shah, Nithin Kamath, Aman Gupta whose founder journey took off in their late 20s. Do NOT default to Sundar Pichai / APJ Kalam / Ratan Tata for young users — they are generations away and break the "someone like me" feel.
...
- perspective: a motivating "put things in context" panel. ALL numbers MUST be INDIA-ONLY statistics — never global/world figures. Every stat must be scoped to India (Indian youth, Indian students, Indian workforce, Indian schools, etc.).
  • statNumber is a big bold figure in millions/crore where useful (e.g. "35 million", "3.2 crore", "68%"). Prefer readable long-form ("35 million") over abbreviations.
  • stat is a one-line framing that EXPLICITLY says "in India" (e.g. "children in India are out of school", "young Indians enter the workforce every year").
  • source cites a credible INDIAN source (NSO / MoSPI, NITI Aayog, UDISE+, ASER, PLFS, NSSO, Ministry of Education, RBI, CMIE, NFHS, Census of India). Global orgs only if quoting their India-specific report.
  • simpleMeaning: 1–2 SHORT sentences a 10-year-old can understand, framed around India. End with a why-it-matters-to-YOU line addressed to the user by name.
  • message: 2 warm sentences turning the India stat into gratitude + fuel for the user by name — not pity.
  • lessPrivileged: a concrete count of young people IN INDIA with FEWER opportunities than the user (Indian kids out of school, Indian teens without internet, first-generation learners in India, etc.). number = big India figure (e.g. "35 million", "1.2 crore"), label = short tag ending in "in India", message = 1–2 kid-friendly sentences addressed by name framing it as motivation.
  • facts are 3 additional INDIA-ONLY grounding stats (number + short label mentioning India + one-line detail), each from a real Indian govt / think-tank / credible India report.
  Prefer recent figures (last 5 years). Never fabricate — if unsure, use a widely-cited India figure. NO global numbers anywhere in this panel.`;
