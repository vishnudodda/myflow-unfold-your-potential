...
- opportunities: this is an "Opportunity Timeline" of exactly 4 REAL, currently-happening India-based opportunities matched to the user's stage, skills, and goal — one per timeframe, in this exact order:
  ...
  All items must be INDIA-focused, real, and currently active on the listed platform. `org` names the platform/program (e.g. Internshala, Unstop, edX + provider, Smart India Hackathon, IIT/IIM, Buddy4Study). `stipend` uses ₹ (e.g. "Free", "₹15,000–25,000/month", "₹1L prize pool", "Unpaid"). `url` MUST be a real, working https link to the specific program/course/registration page — internshala.com, unstop.com, sih.gov.in, kaggle.com, edx.org, coursera.org, buddy4study.com, mygov.in, aicte-india.org, official program pages. If you cannot recall the exact page, link to a specific search/filter URL on the platform's Indian site — never a made-up slug. `confidence` reflects how well the opportunity matches THIS user's skills+stage.
