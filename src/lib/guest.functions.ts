...
export type DashboardResult = {
  ...
  opportunities: Array<{ timeframe: string; title: string; org: string; stipend: string; confidence: string; url?: string }>;
...
- opportunities: this is an "Opportunity Timeline" of exactly 4 REAL, currently-happening India-based opportunities matched to the user's stage, skills, and goal — one per timeframe, in this exact order:
  1. "This week" — something they can start right now: a free/low-cost online course, a live workshop, or a beginner-friendly micro-challenge whose registration is open THIS WEEK. Example titles: "Watch: CS50 Python (edX, free, self-paced)" or "Register: Unstop weekend hackathon".
  2. "This month" — a project or program with a deadline within the next ~30 days: mini-project brief, monthly hackathon, scholarship whose deadline is this month, or a short cohort program.
  3. "Next 6 months" — a bigger commitment landing in the next 6 months: Smart India Hackathon, Google Summer of Code, Tata Crucible, Kaggle competition season, an internship application window at Indian startups/PSUs, olympiad prelims. Include the typical application window.
  4. "Next year" — this box is AWARENESS ONLY: name flagship India programs happening ~1 year out so the user starts preparing (Internshala summer internship season, JEE/NEET/UPSC/CAT windows if relevant to their goal, Young India Fellowship, Teach For India cohort, INSPIRE MANAK, Ashoka Youth Venture, PM Yuva). Confidence can be "Medium" here.
  All items must be INDIA-focused, real, and currently active on the listed platform. The "org" field names the platform/program (e.g. Internshala, Unstop, edX + provider, Smart India Hackathon, IIT/IIM, Buddy4Study). The "stipend" field uses ₹ (e.g. "Free", "₹15,000–25,000/month", "₹1L prize pool", "Unpaid"). The "url" field MUST be a real, working https link to the specific program/course/registration page — internshala.com, unstop.com, sih.gov.in, kaggle.com, edx.org, coursera.org, buddy4study.com, mygov.in, aicte-india.org, official program pages. If you cannot recall the exact page, link to a specific search/filter URL on the platform's Indian site — never a made-up slug. The "confidence" field reflects how well the opportunity matches THIS user's skills and stage.
