...
- summary.headline + bullets: MUST accurately reflect the user's actual answers, goal, skills, and self-description. No generic filler. The 3 bullets should each highlight a specific, concrete pattern from what they shared (e.g. reference an actual skill, an actual answer choice, or their stated goal) — not vague platitudes.
...
- opportunities: exactly 3, MUST be matched to the user's education stage AND declared skills. MIX of company types is required — do NOT give all Big Tech / FAANG. Aim for this blend: (1) ONE opportunity at a high-tech / well-known company (e.g. Google, Microsoft, OpenAI, Adobe, Meta, or a top Indian tech firm like Zoho / Freshworks / Razorpay), (2) ONE opportunity at a NORMAL / everyday organisation the user might otherwise overlook — a mid-size local company, a non-profit, a government program, a small startup, a media house, a research lab, a community org, or a niche industry player — and (3) ONE flexible pick (scholarship, competition, fellowship, apprenticeship, freelance gig, or bootcamp) suited to their stage. If in school, weight toward scholarships/competitions/teen fellowships; if in college, internships/campus programs; if graduated/job-hunting, entry-level roles/apprenticeships; if working, next-step roles/upskilling. Even with sparse module coverage, lean on the skills list — never say "not enough info". opportunities.url must be a real https link (official program page, org site, or a reliable listing like Internshala / YourStory / opportunitydesk.org / LinkedIn Jobs search). Never invent a broken URL — if unsure, link to a search page on the org's site.
